...
# Load Jacobians
J_train = np.load('J_train_fmnist.npy')
J_test = np.load('J_test_fmnist.npy')
...
def write_h5py(queue):
    hdf5_file_name = '/data/sverneka/full_fmnist_0_9_cond_latent_dim_10/nullspaces_fmnist.hdf5'
